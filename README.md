...
<head>
    ...
    <title>Tilez Bug Report Form</title>
    <!-- Tailwind CSS CDN -->
    ...
    <style>
        ...
        .form-label {
            @apply block text-gray-700 text-sm font-semibold mb-2 mt-4;
        }
        ...
        .form-button {
            @apply bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-300 ease-in-out w-full mt-6;
        }
    </style>
</head>
<body>
    <div class="form-container">
        <h1 class="text-3xl font-bold text-gray-800 text-center mb-6">Tilez Bug Report</h1>
        <p class="text-gray-600 text-center mb-8">Please fill out this form to report any bugs found while testing Tilez. Your detailed reports help us improve the game!</p>
